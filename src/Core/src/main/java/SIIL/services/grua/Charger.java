 ...
 * @author Azael Reyes
 */
public class Charger extends database.mysql.stock.Titem
{
    public static final String MYSQL_AVATAR_TABLE = "Charger";
    ...
    public static boolean isCharger(Database database, Titem titem) throws SQLException 
    {
