...
public class POTest 
{
    ...
    public void testInsert() throws Exception {
        ...
        PO instance = new PO(-1);        
        Return result = null;
        try 
        {
            result = instance.insert(dbserver,office,state,operator,dbserver.getTimestamp(),prov,0,"DEV",PO.TYPE);
            instance.upFlag(connection, 'A');
        } 
        catch (SQLException ex) 
        {
            //Logger.getLogger(OperationalTest.class.getName()).log(Level.SEVERE, null, ex);
    ...
    /**
     * Test of search method, of class PO.
     */
    @Test
