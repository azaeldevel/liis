...
public class MinaTest 
{
    ...
    /**
     * Test of selectRandom method, of class Mina.
     */
    @Test
    ...
    /**
     * Test of insert method, of class Mina.
     */
    @Test
    public void testInsert()
    {
        ...
        Mina item = new Mina(-1);
        Return<Integer> result;
        try 
        {
            result = item.insert(dbserver.getConnection(),"TEST-" + sdf.format(date) + "-" + Result,"Mina de Prueba." + sdf.format(date),Titem.Import.NoImport,false,"");
        }  
