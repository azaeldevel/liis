...
{    
    ...
    /**
     * Test of selectRandom method, of class Battery.
     */
    @Test
    ...
    /**
     * Test of insert method, of class Battery.
     */
    @Test
    public void testInsert()
    {
        ...
        Battery item = new Battery(-1);
        Return<Integer> result;
        Return<Integer> retMake = null;
        Return<Integer> retModel = null;
        try 
        {
            result = item.insert(dbserver.getConnection(),"TEST-" + sdf.format(date) + "-" + Result,"Bateria de Prueba." + sdf.format(date),Titem.Import.NoImport,false,"");            
