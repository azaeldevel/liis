...
public class QuotationTest 
{
    ...
    /**
     * Test of insert method, of class Quotation.
     */
    @Test
    public void testInsert() 
    {
        ...
        database.mysql.sales.Quotation instance = new database.mysql.sales.Quotation(-1);        
        Return result = null;
        try 
        {
            result = instance.insert(dbserver,office, state,operator,dbserver.getTimestamp(),company,Result,"DEV","PQ");
        } 
        catch (SQLException ex) 
        {
            //Logger.getLogger(OperationalTest.class.getName()).log(Level.SEVERE, null, ex);
