...
public class HequiTest 
{
    ...
    /**
     * Test of insert method, of class Hequi.
     */
    @Test
    public void testInsert()
    {
        ...
        try {
            result = item.insert(dbserver.getConnection(),"TEST-" + sdf.format(date) + "-" + Result,"Hequio y Material de prueba " + sdf.format(date),Titem.Import.NoImport,false,"");
        }  
    ...
    /**
     * Test of clean method, of class Hequi.
     */
    @Test
