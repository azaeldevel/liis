...
public class Calendario extends JPanel implements PropertyChangeListener
{
	 ...
	 *            the new locale
	 */
	public Calendario(Locale locale) {
	 ...
	 *            the new locale
	 */
	public Calendario(Date date, Locale locale) {
	 ...
	 */
	public Calendario(Date date, boolean monthSpinner) {
	 ...
	 *            false, if no month spinner should be used
	 */
	public Calendario(Locale locale, boolean monthSpinner) {
	 ...
	 *            false, if no month spinner should be used
	 */
	public Calendario(boolean monthSpinner) {
	 ...
	 */
	public Calendario(Date date, Locale locale, boolean monthSpinner,boolean weekOfYearVisible) 
        {
            setName("Calendario");
	...
	public static void main(String[] s) {
		...
		Calendario jcalendar = new Calendario();
