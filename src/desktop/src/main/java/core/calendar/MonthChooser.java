 ...
 */
public class MonthChooser extends JPanel implements ItemListener,
		ChangeListener {
	 ...
	 */
	public MonthChooser(boolean hasSpinner) {
		super();
		setName("MonthChooser");
	...
	public static void main(String[] s) {
		...
		frame.getContentPane().add(new MonthChooser());
		frame.pack();
