...
import SIIL.services.trabajo.RelacionTableModel;
...
public class DateChooser extends JPanel implements ActionListener,PropertyChangeListener 
{
	...
	private ChangeListener changeListener;
        private SIIL.services.trabajo.Relacion relacion;
	 ...
	 */
	public DateChooser(IDateEditor dateEditor) {
	 ...
	 *            format is used)
	 */
	public DateChooser(Date date, String dateFormatString) {
	 ...
	 */
	public DateChooser(String datePattern, String maskPattern, char placeholder) {
	 ...
	 *            JTextFieldDateEditor is used.
	 */
	public DateChooser(Calendario jcal, Date date, String dateFormatString,IDateEditor dateEditor) 
        {
		setName("DateChooser");
		...
		if (jcal == null) {
			calendario = new Calendario(date);
		} else {
			calendario = jcal;
			if (date != null) {
		...
		calendario.getDayChooser().addPropertyChangeListener("day", this);
		...
		calendario.getDayChooser().setAlwaysFireDayProperty(true);
                //calendario.addMouseListener(this);
		...
		changeListener = new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				...
				if (popup.isVisible()
						&& DateChooser.this.getCalendario().monthChooser
		...
		// end of code provided by forum user podiatanapraia
                ...
                addPropertyChangeListener(this);//Azael
        ...
        {
            Calendar selected = getCalendario().getCalendar();
            System.out.println("This date: " + selected.getTime());
        }
	...
	public void actionPerformed(ActionEvent e) 
		...
		calendar.setTime(date);
            ...
            getCalendario().setCalendar(calendar);
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if (evt.getPropertyName().equals("day")) 
			...
			if (((Integer)evt.getNewValue()).intValue() > 0) 
                        {
                            setDate(getCalendario().getCalendar().getTime());
			} 
                        else 
                        {
                            setDate(null);
	 ...
	 */
	public Calendario getJCalendar() {
	...
	public void setSelectableDateRange(Date min, Date max) {
		getCalendario().setSelectableDateRange(min, max);
		dateEditor.setSelectableDateRange(getCalendario().getMinSelectableDate(),
				getCalendario().getMaxSelectableDate());
	}

	public void setMaxSelectableDate(Date max) {
		getCalendario().setMaxSelectableDate(max);
		dateEditor.setMaxSelectableDate(max);
	}

	public void setMinSelectableDate(Date min) {
		getCalendario().setMinSelectableDate(min);
	...
	public Date getMaxSelectableDate() {
		return getCalendario().getMaxSelectableDate();
	}
	...
	public Date getMinSelectableDate() {
		return getCalendario().getMinSelectableDate();
	}
     ...
     */
    public void setRelacion(SIIL.services.trabajo.Relacion relacion) {
