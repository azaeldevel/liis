 ...
 * @author Azael Reyes
 */
public class AsociacionMasiva extends javax.swing.JPanel 
{
    ...
    /**
     * Creates new form AsociacionMasiva
     */
    public AsociacionMasiva() {
        initComponents();
        openDatabase(true);
    ...
    private void btAssociateAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAssociateAllActionPerformed
        ...
        List<Association<Remision>> associations = null;
        Return ret = null;
        try 
        {
            associations = new ArrayList<>();
            Remision.massAssociationReadDirectory(dbserver, directory, associations, logger, office); 
            ...
            ret = Remision.massAssociation(dbserver, ftpServer, directory, logger, associations, null, office, null,pregress);
        }
        ...
        if(ret.isFlag())
        {
            ...
            if(seleccion == JOptionPane.YES_OPTION)
            {
                ...
                {
                    dbserver.commit();
                    Remision.massAssociationCleanDirectory(associations);
                }
