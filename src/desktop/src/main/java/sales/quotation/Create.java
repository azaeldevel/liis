...
public class Create extends javax.swing.JPanel implements core.DialogContent
{
    ...
    private void btCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCreateActionPerformed
        Quotation quo = new Quotation(-1);  
        Return ret = null;
        try 
        {
            State state = new State(-1);
            state.select(dbserver, State.Steps.SALES_QUOTATION);
            ret = quo.insert(dbserver, SIIL.servApp.cred.getOffice(), state, null, dbserver.getDateToday(), comp, 0, SIIL.servApp.cred.getOffice().getSerieOffice(Office.Platform.TOOLS), "SQ");
            quo.downSerie(dbserver);
            quo.downFolio(dbserver);
        }
        ...
        (
            this,
            "Creo la cotizacion '" + quo.toString() + "', ¿Desea continuar?",
            "Confirmar operacion",
