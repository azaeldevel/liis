...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Persons` (
  ...
  PRIMARY KEY (`pID`),
  UNIQUE INDEX `nombrekey` (`nameN1` ASC, `nameAP` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Users` (
  ...
  INDEX `fk_tbl_usuarios_Persona1` (`uID` ASC),
  PRIMARY KEY (`alias`),
  UNIQUE INDEX `unique` (`uID` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`StockItem` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_StockItem_PurchasesProvider1_idx` (`provider` ASC),
  UNIQUE INDEX `UNIQUENUMBER` (`number` ASC),
  INDEX `fk_StockItem_StockClaveFiscal1_idx` (`claveFical` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Titem` (
  `BD` ENUM('bc.tj','bc.mx','bc.ens') NOT NULL,
  `number` VARCHAR(30) NOT NULL,
  `marca` VARCHAR(45) NULL COMMENT '@deprecated',
  `modelo` VARCHAR(45) NULL,
  `serie` VARCHAR(45) NULL,
  `class` ENUM('forklift','battery','charger','titem') NULL,
  `id` INT(11) NULL,
  INDEX `fk_Titem_StockItem1_idx` (`id` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`ProcessStates` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_ProcessStates_ProcessModule1_idx` (`module` ASC),
  UNIQUE INDEX `oneByMod` (`module` ASC, `ordinal` ASC),
  INDEX `oneByCode` (`module` ASC, `code` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`ProcessOperational` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_ProcessOperational_ProcessStates1_idx` (`state` ASC),
  INDEX `fk_ProcessOperational_Persons1_idx` (`operator` ASC),
  INDEX `fk_ProcessOperational_Offices1_idx` (`office` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`SalesOperational` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_SalesOperational_Companies1_idx` (`company` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`SalesRemision` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_SalesRemision_Bobeda1_idx` (`archivoOS` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Movements` (
  ...
  `uso` ENUM('disp', 'rtacp', 'pres', 'rtaoc','rta', 'rep', 'vta', 'mov', 'baja', 'tpint', 'corr', 'otras') NULL,
  ...
  `sa2` INT(11) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Movements_Users1_idx` (`createUser` ASC),
  INDEX `CNCompany` (`compNumber` ASC),
  INDEX `ixFH` (`fhMov` ASC),
  INDEX `ixFolio` (`folio` ASC),
  INDEX `fk_Movements_SalesRemision1_idx` (`sa2` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`BobedaBusiness` (
  ...
  PRIMARY KEY (`bobeda`),
  INDEX `fk_BobeSales_Companies1_idx` (`company` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Orcom` (
  ...
  `company` INT(11) NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_Orcom_Users1_idx` (`creator` ASC),
  INDEX `fk_Orcom_Persons2_idx` (`technicalPerson` ASC),
  INDEX `fk_Orcom_Persons1_idx` (`ownerPerson` ASC),
  INDEX `index1` (`fhAutho` DESC),
  INDEX `indes2` (`fhETA` DESC),
  INDEX `index3` (`fhArribo` DESC),
  INDEX `index4` (`fhSurtido` DESC),
  INDEX `index5` (`fhFin` DESC),
  INDEX `index6` (`fhFolio` DESC),
  INDEX `index7` (`fhEdit` DESC),
  INDEX `ixClient` (`compNumber` ASC),
  INDEX `ixFolio` (`folio` ASC),
  INDEX `index8` (`fhETAfl` DESC),
  INDEX `ixEstado` (`estado` ASC),
  INDEX `ixSuc` (`suc` ASC),
  INDEX `index9` (`fhFinfl` DESC),
  INDEX `fk_Orcom_SalesQuotation1_idx` (`quotation` ASC),
  INDEX `fk_Orcom_Persons3_idx` (`ownerPerson2` ASC),
  INDEX `fk_Orcom_Persons4_idx` (`pAutho` ASC),
  INDEX `fk_Orcom_BobedaBusiness1_idx` (`poFile` ASC),
  INDEX `fk_Orcom_Companies1_idx` (`company` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`SalesQuotation` (
  ...
  `orserv` INT(11) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_SalesQuotation_Orcom1_idx` (`orserv` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`PurchasesOperational` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_PurchasesOperational_PurchasesProvider1_idx` (`provider` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`StockFlow` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_StockFlow_StockItem1_idx` (`idItem` ASC),
  INDEX `fk_StockFlow_SalesQuotation1_idx` (`quotation` ASC),
  INDEX `fk_StockFlow_PurchasesOrder1_idx` (`po` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Resumov` (
  ...
  `uso` ENUM('disp', 'rtacp', 'pres', 'rtaoc','rta', 'rep', 'vta', 'mov', 'baja', 'tpint', 'corr', 'otras') NOT NULL,
  `note` TINYTEXT NULL,
  ...
  `poFIle` INT(11) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Resumov_GruaUso1_idx` (`use` ASC),
  INDEX `fk_Resumov_Offices1_idx` (`office` ASC),
  INDEX `fk_Resumov_StockFlow1_idx` (`titem` ASC),
  INDEX `fk_Resumov_SalesRemision1_idx` (`sa` ASC),
  INDEX `fk_Resumov_Bobeda1_idx` (`poFIle` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Charger` (
  ...
  `number` VARCHAR(30) NOT NULL,
  `id` INT(11) NULL,
  INDEX `fk_Charger_Titem2_idx` (`id` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Battery` (
  ...
  `id` INT(11) NULL,
  INDEX `fk_Battery_Titem2_idx` (`id` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Forklift` (
  ...
  INDEX `fk_Forklift_Titem2_idx` (`id` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Movtitems` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_table1_Movements1_idx` (`mov` ASC),
  INDEX `CN` (`numeco` ASC),
  INDEX `fk_Movtitems_StockFlow1_idx` (`itemFlow` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Minas` (
  ...
  `number` VARCHAR(30) NOT NULL,
  `id` INT(11) NULL,
  INDEX `fk_Minas_Titem2_idx` (`id` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`AccesTable` (
  ...
  INDEX `fk_AccesTable_Policies1_idx` (`policy` ASC),
  INDEX `fk_AccesTable_Users1_idx` (`alias` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Trace` (
  ...
  `trace` INT NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_Trace_Users1_idx` (`user` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`OrcomOwners` (
  `owner` INT NOT NULL,
  INDEX `fk_OrcomOwners_Persons1_idx` (`owner` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`PurchaseCR` (
  ...
  `payDate` DATE NULL,
  INDEX `fk_PurchaseCR_Users1_idx` (`recibe` ASC),
  INDEX `fk_PurchaseCR_Users2_idx` (`payUser` ASC),
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`ServiosOrdenEstado` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE INDEX `indexCode` (`code` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Configuration` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `fk_Configuration_Users1_idx` (`user` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Instances` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `fk_Instances_Users1_idx` (`user` ASC),
  UNIQUE INDEX `identificator` (`address` ASC, `hascode` ASC, `user` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`ContabilidadAsientos` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_SIILContabilidadRegistro_SIILCatalogoCuentas1_idx` (`cuentaCargo` ASC),
  INDEX `fk_SIILContabilidadRegistro_SIILCatalogoCuentas2_idx` (`cuentaAbono` ASC),
  INDEX `fk_ContabilidadAsientos_ProcessOperational1_idx` (`operation` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`StockOffice` (
  ...
  PRIMARY KEY (`idItem`),
  INDEX `fk_StockOffice_StockItem1_idx` (`idItem` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`StockRefection` (
  `idItem` INT(11) NOT NULL,
  INDEX `fk_StockRefection_StockItem1_idx` (`idItem` ASC),
  PRIMARY KEY (`idItem`),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`AdministracionBuilding` (
  ...
  `name` VARCHAR(50) NOT NULL,
  `parent` INT NULL,
  INDEX `fk_Building_Offices1_idx` (`office` ASC),
  PRIMARY KEY (`id`),
  INDEX `fk_AdministracionBuilding_AdministracionBuilding1_idx` (`parent` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`StockContainer` (
  ...
  `parent` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_StockContainer_AdministracionBuilding1_idx` (`building` ASC),
  INDEX `fk_StockContainer_StockContainer1_idx` (`parent` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`AdministracionEstacion` (
  ...
  INDEX `fk_AdministracionEstacion_Persons1_idx` (`owner` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`StockAllocated` (
  ...
  `item` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_StockAllocated_StockContainer1_idx` (`container` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`StockSetem` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_StockSetem_StockItem1_idx` (`id` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`StockCross` (
  ...
  INDEX `fk_StockCross_StockRefection1_idx` (`refection` ASC),
  INDEX `fk_StockCross_StockRefection2_idx` (`cross` ASC),
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`StockExternal` (
  ...
  INDEX `fk_StockExternal_StockRefection1_idx` (`id` ASC),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_StockExternal_StockRefection2_idx` (`extern` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`ProcessOperationalRows` (
  ...
  `fechaETA` DATE NULL,
  INDEX `fk_ProcessOperationalRows_StockFlow1_idx` (`item` ASC),
  PRIMARY KEY (`id`),
  INDEX `fk_ProcessOperationalRows_ProcessOperational1_idx` (`op` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`ServicesOrder` (
  ...
  `archivo` INT(11) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_ServicesOrder_Companies1_idx` (`company` ASC),
  INDEX `fk_ServicesOrder_Orcom1_idx` (`quoteService` ASC),
  INDEX `fk_ServicesOrder_StockFlow1_idx` (`itemFlow` ASC),
  INDEX `fk_ServicesOrder_Offices1_idx` (`office` ASC),
  INDEX `fk_ServicesOrder_technical_idx` (`technical` ASC),
  INDEX `fk_ServicesOrder_SalesRemision1_idx` (`SalesRemision` ASC),
  INDEX `fk_ServicesOrder_Bobeda1_idx` (`archivo` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`HistoryConsume` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_HistoryConsume_StockItem1_idx` (`consumer` ASC),
  INDEX `fk_HistoryConsume_StockItem2_idx` (`intake` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`ServiceOrderResumen` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_ServiceOrderGroups_ServicesOrder1_idx` (`lastServ` ASC),
  INDEX `fk_ServiceOrderResumen_ServiceOrderModules1_idx` (`module` ASC),
  INDEX `fk_ServiceOrderResumen_StockFlow1_idx` (`flowItem` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`ServicesTrabajo` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_ServiceTrabajo_ProcessStates1_idx` (`state` ASC),
  INDEX `fk_ServiceTrabajo_Companies1_idx` (`company` ASC),
  INDEX `fk_ServiceTrabajo_Mechanic_idx` (`mechanic` ASC),
  INDEX `fk_ServicesTrabajo_SalesRemision1_idx` (`sa` ASC),
  INDEX `fk_ServicesTrabajo_Orcom1_idx` (`quotedService` ASC),
  INDEX `fk_ServicesTrabajo_Offices1_idx` (`office` ASC),
  INDEX `fk_ServicesTrabajo_ServicesOrder1_idx` (`orderServ` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`ProcessMailerAttaches` (
  ...
  INDEX `fk_ProcessMailerAttaches_ProcessMailer1_idx` (`mail` ASC),
  INDEX `fk_ProcessMailerAttaches_Bobeda1_idx` (`vault` ASC),
  INDEX `fk_ProcessMailerAttaches_Companies1_idx` (`company` ASC),
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`SalesInvoice` (
  ...
  `trabajo` INT(11) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_SalesInvoice_ProcessMailer1_idx` (`email` ASC),
  INDEX `fk_SalesInvoice_Bobeda1_idx` (`xml` ASC),
  INDEX `fk_SalesInvoice_Bobeda2_idx` (`pdf` ASC),
  INDEX `fk_SalesInvoice_Bobeda3_idx` (`ordenesArchivo` ASC),
  INDEX `fk_SalesInvoice_ServicesTrabajo1_idx` (`trabajo` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`SA_Factura` (
  ...
  `sa` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_SI_SR_SalesInvoice1_idx` (`invoice` ASC),
  INDEX `fk_SI_SR_SalesRemision1_idx` (`sa` ASC),
  UNIQUE INDEX `sa_UNIQUE` (`sa` ASC),
...
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`SATClaves` (
  ...
  INDEX `fk_SATCatalogoClaves_SATCatalogos1_idx` (`catalog` ASC),
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DBSSIIL`.`Resumov_ResolvedFull` (`fnumber` INT, `orden` INT, `fBD` INT, `fmarca` INT, `fmodelo` INT, `fserie` INT, `cBD` INT, `cnumber` INT, `cname` INT, `suc` INT, `uso` INT, `note` INT, `fhmov` INT, `batteryBD` INT, `batteryNumber` INT, `chargerBD` INT, `chargerNumber` INT, `poFile` INT);
